...
....
Set SystemDesign, FrontendDesign, ObjectOrientedDesign, ProductDesign, InfrastructureDesign

IsSubset(ProductDesign, SystemDesign)
IsSubset(FrontendDesign, ProductDesign)
IsSubset(ObjectOrientedDesign, ProductDesign)
IsSubset(InfrastructureDesign, ProductDesign)

Not(Intersecting(InfrastructureDesign, ObjectOrientedDesign))
Not(Intersecting(InfrastructureDesign, FrontendDesign))
